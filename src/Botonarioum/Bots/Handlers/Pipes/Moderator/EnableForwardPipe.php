...
class EnableForwardPipe extends CallbackPipe
{
    /**
    ...
    public function isSupported(Update $update): bool
    {
        ...
        if (false === strpos($update->getCallbackQuery()->getData(), implode(':', ['moderator', 'group', 'settings', 'forward', 'enable']))) return false;
