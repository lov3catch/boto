...
class ModeratorDeleteMediaGreetingMessagesCommand extends Command
{
    protected static $defaultName = 'ModeratorDeleteMediaGreetingMessages';
    /**
     * @var Client
     */
    private $client;
    ...
    private function clear(string $greetingsRedisKey, SymfonyStyle $io): void
    {
        ...
        foreach ($otherGreeting as $greeting) {
            try {
                $io->note('MODERATOR REMOVE GREETING MEDIA');
