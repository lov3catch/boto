 ...
 */
final class Version20191229200704 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE moderator_setting (id INT NOT NULL, is_default BOOLEAN NOT NULL, PRIMARY KEY(id))');
    }
