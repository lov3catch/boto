 ...
 */
final class Version20200125113159 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE moderator_setting ADD greeting VARCHAR(500) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX "primary"');
        $this->addSql('ALTER TABLE moderator_setting DROP greeting');
