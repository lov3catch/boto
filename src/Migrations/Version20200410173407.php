 ...
 */
final class Version20200410173407 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE moderator_setting ADD greeting_files JSON DEFAULT NULL');
...
//        $this->addSql('ALTER TABLE channel ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE moderator_setting DROP greeting_files');
