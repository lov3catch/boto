 ...
 */
final class Version20200209143857 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE moderator_blocks ALTER id DROP DEFAULT');
        ...
        $this->addSql('ALTER TABLE moderator_setting ADD greeting_buttons VARCHAR(10000) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE moderator_setting DROP greeting_buttons');
        ...
        $this->addSql('CREATE SEQUENCE moderator_blocks_id_seq');
        $this->addSql('SELECT setval(\'moderator_blocks_id_seq\', (SELECT MAX(id) FROM moderator_blocks))');
        $this->addSql('ALTER TABLE moderator_blocks ALTER id SET DEFAULT nextval(\'moderator_blocks_id_seq\')');
