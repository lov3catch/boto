...
final class Version20190525065456 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE element DROP CONSTRAINT fk_41405e394d18fad3');
        $this->addSql('ALTER TABLE element DROP CONSTRAINT fk_41405e39714819a0');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE element ADD CONSTRAINT fk_41405e394d18fad3 FOREIGN KEY (platform_id_id) REFERENCES platform (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE element ADD CONSTRAINT fk_41405e39714819a0 FOREIGN KEY (type_id_id) REFERENCES element_type (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
