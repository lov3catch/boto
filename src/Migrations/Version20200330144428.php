 ...
 */
final class Version20200330144428 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("ALTER TABLE moderator_setting ADD stop_words JSON NOT NULL DEFAULT '[]'::json");
...
//        $this->addSql('ALTER TABLE channel ADD PRIMARY KEY (id)');
        $this->addSql('ALTER TABLE moderator_setting DROP stop_words');
    }
}
