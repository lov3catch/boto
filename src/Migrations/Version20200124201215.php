 ...
 */
final class Version20200124201215 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE moderator_setting ADD allow_link BOOLEAN DEFAULT \'false\' NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX "primary"');
        $this->addSql('ALTER TABLE moderator_setting DROP allow_link');
